...
export function About() {
  ...
  return (
    <div className="w-full h-full flex flex-col md:flex-row items-stretch justify-start gap-4">
      ...
      {skills && (
        <div className="w-full md:w-1/2 grid grid-cols-2 gap-4 text-background bg-foreground p-8">
          {skills.map((skill) => (
